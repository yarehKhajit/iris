...
*7 - ${prefix}dog*
_¿Amas a los cachorros? Porque yo si!!_
...
*10 - ${prefix}Idiomas*
_para usar con el comando de arriba._
...
*15 - ${prefix}neko*
_Bueno ...siempre una neko se ve linda_
...
*32 - ${prefix}Flip*
_El viejo juego de cara , cruz..._
...
*77 - ${prefix}quack*
_cuack! ve algunos patos ~gansos~ o lo que sea...?_
...
*si un comando no sirve no lo vuelvas a usar.*`
}
